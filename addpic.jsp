                ...
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <form action="PersonController?op=add" method="post" enctype="multipart/form-data" class="form">
                            ...
                            <img src="assests/images/nopic.jpg" style="width:300px;height: 300px" class="img img-thumbnail" id="preview"/> <br/>
                            ...
                            <br/>
                            <a href="index.jsp" class="btn btn-success"> << Check Previous Data</a>
                        <%} else {
